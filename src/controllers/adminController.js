...
exports.login = async (req, res) => {
    try {
        ...
        const decryptedPass = crypto.AES.decrypt(admin.password, process.env.PASSWORD_SECRET_KEY).toString(crypto.enc.Utf8);
...
exports.summary = async (req, res) => {
    try {
        ...
        console.log("userVaccinated", userVaccinated);
        ...
        console.log("totalVaccineDose", totalVaccineDose);
